...
public static class V2Endpoints
{
    ...
    private static IResult Error(string code, string message)
    {
        var status = code switch
        {
            ...
            "IDEMPOTENCY_CONFLICT" or "SERVICE_MISMATCH" or "RENDER_PRINTER_MISMATCH" or "RENDER_CHANGED" or "PRINTER_PROFILE_CHANGED" or "PRINTER_SETTINGS_CHANGED" or "JOB_NOT_REPRINTABLE" or "REPRINT_CONTENT_CHANGED" => 409,
