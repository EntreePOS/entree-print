...
Latest verified development candidate: [run 34834821106](https://github.com/EntreePOS/entree-print/actions/runs/34834821106), source `911ee37c135d270023ee86fcc74b45c4dcc20717`, includes optional HTTPS, secure discovery/recovery, ordered receipt actions, resumable status updates, native SQLite storage and the Chromium startup-file fix. All 386 application tests, 98 core SDK tests, nine SQLite tests and 64 installer checkpoints pass. [Exact result](evidence/windows-ci-34834821106.json) and PACKAGE_VERIFICATION.md identify its independently verified installer hash and limits. Installed certificate trust/private-key access and live service deployment remain pilot checks.
