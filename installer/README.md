...
The latest verified candidate is [run 34845782279](https://github.com/EntreePOS/entree-print/actions/runs/34845782279), source `e753a5543311d6ceab0d174794294d2babb544b3`, including owner-aware SDK recovery and portable receipt preparation. All 461 application tests, 134 core SDK tests, eleven SQLite tests and 64 hosted installer checkpoints pass. [Exact evidence](evidence/windows-ci-34845782279.json) and PACKAGE_VERIFICATION.md identify the downloaded, hash-verified EXE. Printing is inactive during hosted installation tests; live service, printer/network, automatic backup routing and tray/logon verification remain open.
