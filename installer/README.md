...
The latest verified candidate is [run 34844339986](https://github.com/EntreePOS/entree-print/actions/runs/34844339986), source `2975bf86700150124a76556fc79879dc52d9d787`, including portable receipt preparation. All 461 application tests, 121 core SDK tests, eleven SQLite tests and 64 hosted installer checkpoints pass. [Exact evidence](evidence/windows-ci-34844339986.json) and PACKAGE_VERIFICATION.md identify the downloaded, hash-verified EXE. Printing is inactive during hosted installation tests; live service, printer/network, automatic backup routing and tray/logon verification remain open.
